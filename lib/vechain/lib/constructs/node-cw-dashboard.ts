    ...
    "widgets": [
        ...
        },
        {
            ...
            "properties": {
                ...
                "region": "${REGION}",
                "metrics": [
                    ["CWAgent", "vet_best_block", "InstanceId", "${INSTANCE_ID}", { "label": "Vechain Best Block" }]
                ],
                "title": "Vechain Best Block (number)"
            }
        },
        {
            "height": 4,
        ...
        },
        {
            ...
            "properties": {
                "metrics": [
                    ["CWAgent", "disk_used_percent", "InstanceId", "${INSTANCE_ID}", "device", "nvme1n1", "path", "/thor", "fstype", "ext4", { "region": "${REGION}", "label": "/thor" }]
                ],
                "sparkline": true,
                "view": "singleValue",
                "region": "${REGION}",
