...
echo "TZ_OCTEZ_VERSION=${_TZ_OCTEZ_VERSION_}" >> /etc/environment
...
if [ "$arch" == "x86_64" ]; then
  if ["$TZ_OCTEZ_VERSION" == "19.2"]; then
    curl -o /usr/local/bin/octez-node https://gitlab.com/tezos/tezos/-/package_files/123084614/download
    curl -o /usr/local/bin/octez-client https://gitlab.com/tezos/tezos/-/package_files/123084570/download
  else
    curl -o /usr/local/bin/octez-node https://gitlab.com/tezos/tezos/-/package_files/121917448/download
    curl -o /usr/local/bin/octez-client https://gitlab.com/tezos/tezos/-/package_files/121917349/download
  fi
else
  if ["$TZ_OCTEZ_VERSION" == "19.2"]; then
    curl -o /usr/local/bin/octez-node https://gitlab.com/tezos/tezos/-/package_files/123085219/download
    curl -o /usr/local/bin/octez-client https://gitlab.com/tezos/tezos/-/package_files/123085169/download
  else
    curl -o /usr/local/bin/octez-node https://gitlab.com/tezos/tezos/-/package_files/121918903/download
    curl -o /usr/local/bin/octez-client https://gitlab.com/tezos/tezos/-/package_files/121918713/download
  fi
fi
