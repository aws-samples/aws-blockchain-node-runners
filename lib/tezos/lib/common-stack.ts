...
export interface TzCommonStackProps extends cdk.StackProps {

}

export class TzCommonStack extends cdk.Stack {
    AWS_STACK_NAME = cdk.Stack.of(this).stackName;
    AWS_ACCOUNT_ID = cdk.Stack.of(this).account;

    constructor(scope: cdkConstructs.Construct, id: string, props: TzCommonStackProps) {
        ...
        instanceRole.addToPolicy(new iam.PolicyStatement({
            resources: [`arn:aws:autoscaling:${region}:${this.AWS_ACCOUNT_ID}:autoScalingGroup:*:autoScalingGroupName/tz-*`],
        ...
        new cdk.CfnOutput(this, "Instance Role ARN", {
            ...
            exportName: "TzNodeInstanceRoleArn"
        });
