...
export interface HubbleAMBEthereumSingleNodeStackProps extends cdk.StackProps {
    ambEthereumNodeNetworkId: configTypes.AMBEthereumNodeNetworkId,
    ambEthereumNodeInstanceType: string,
}

export class HubbleAMBEthereumSingleNodeStack extends cdk.Stack {
    constructor(scope: cdkConstructs.Construct, id: string, props: HubbleAMBEthereumSingleNodeStackProps) {
