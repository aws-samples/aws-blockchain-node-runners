...
import * as configTypes from "./config/hubbleConfig.interface";
import * as constants from "../../constructs/constants";
import { HubbleNodeSecurityGroupConstruct } from "./constructs/hubble-node-security-group";

export interface HubbleSingleNodeStackProps extends cdk.StackProps {
    instanceType: ec2.InstanceType;
    instanceCpuType: ec2.AmazonLinuxCpuType;
    hubbleNetworkId: configTypes.HubbleNetworkId;
    nodeConfiguration: configTypes.HubbleNodeConfiguration;
    dataVolume: configTypes.HubbleDataVolumeConfig;
}

export class HubbleSingleNodeStack extends cdk.Stack {
    constructor(scope: cdkConstructs.Construct, id: string, props: HubbleSingleNodeStackProps) {
        ...
        // Setting up the security group for the node from Hubble-specific construct
        const instanceSG = new HubbleNodeSecurityGroupConstruct (this, "security-group", {
            vpc: vpc,
        })
        ...
        const importedInstanceRoleArn = cdk.Fn.importValue("HubbleNodeInstanceRoleArn");
        ...
        const modifiedInitNodeScript = cdk.Fn.sub(nodeStartScript, {
            ...
            _HUBBLE_NODE_TYPE_: nodeConfiguration,
            _LIFECYCLE_HOOK_NAME_: constants.NoneValue,
            _ASG_NAME_: constants.NoneValue,
            _ETH_MAINNET_RPC_URL_: ambEthereumNodeRpcUrlWithBillingToken,
            _OPTIMISM_L2_RPC_URL_: nodeConfiguration,
            _HUB_OPERATOR_FID_: nodeConfiguration,
            _FC_NETWORK_ID_: constants.NoneValue,
            _BOOTSTRAP_NODE_: constants.NoneValue,
        });
        ...
        new cw.CfnDashboard(this, 'hubble-cw-dashboard', {
