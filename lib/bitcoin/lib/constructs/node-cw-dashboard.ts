export const SingleNodeCWDashboardJSON = {
    "widgets": [
        ...
        },
        {
            ...
            "properties": {
                "metrics": [
                    [ "CWAgent", "bitcoin_block_height", "InstanceId", "${INSTANCE_ID}", { "label": "${INSTANCE_ID}-${INSTANCE_NAME}" } ]
                ],
                "sparkline": true,
                "view": "timeSeries",
                "stacked": false,
        ...
        },
        {
            ...
            "properties": {
                ...
                "period": 60,
                "metrics": [
                    [ "CWAgent", "bitcoin_verification_progress", "InstanceId", "${INSTANCE_ID}", { "label": "${INSTANCE_ID}-${INSTANCE_NAME}" } ]
                ],
                "title": "Bitcoin Verification Progress"
            }
        },
        {
            "height": 5,
            ...
            "properties": {
                ...
                "stat": "Sum",
                "period": 60,
                "title": "Data Volume Read/Write (IO/sec)"
            }
        },
        {
            "height": 5,
            ...
            "properties": {
                ...
                "title": "Data Volume Read/Write latency (ms/op)"
            }
        },
        {
            "height": 5,
            ...
            "properties": {
                ...
                "stat": "Average",
                "period": 60,
                "title": "Data Volume Read/Write throughput (bytes/sec)"
            }
        },
        {
            "height": 3,
        ...
        },
        {
            ...
            "properties": {
                "metrics": [
                    [ { "expression": "SELECT AVG(disk_used_percent) FROM CWAgent WHERE path = '/data' AND InstanceId = '${INSTANCE_ID}'", "label": "/data", "id": "q1" } ]
                ],
                "sparkline": true,
                "view": "singleValue",
                "region": "${REGION}",
        ...
        },
        {
            ...
            "properties": {
                ...
                "period": 60,
                "metrics": [
                    [ "CWAgent", "bitcoin_connections", "InstanceId", "${INSTANCE_ID}", { "label": "${INSTANCE_ID}-${INSTANCE_NAME}" } ]
                ],
                "title": "Bitcoin Peer Connections"
            }
        },
        {
            "height": 5,
            ...
            "properties": {
                ...
                "period": 60,
                "metrics": [
                    [ "CWAgent", "bitcoin_mempool_size", "InstanceId", "${INSTANCE_ID}", { "label": "${INSTANCE_ID}-${INSTANCE_NAME}" } ]
                ],
                "title": "Bitcoin Mempool Size (txs)"
            }
        }
    ]
};
