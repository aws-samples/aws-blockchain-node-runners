...
echo "Ethereum Client combination: $CLIENT_COMBINATION"
...
if [ "$CLIENT_COMBINATION" = "erigon-lighthouse-mainnet" ] || [ "$CLIENT_COMBINATION" = "erigon-prysm-mainnet" ]; then
