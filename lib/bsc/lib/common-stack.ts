...
export class BscCommonStack extends cdk.Stack {
    ...
    constructor(scope: cdkConstructs.Construct, id: string, props: BscCommonStackProps) {
        ...
        instanceRole.addToPolicy(new iam.PolicyStatement({
            resources: [`arn:aws:autoscaling:${region}:${this.AWS_ACCOUNT_ID}:autoScalingGroup:*:autoScalingGroupName/bsc-*`],
        ...
        new cdk.CfnOutput(this, "Instance Role ARN", {
            ...
            exportName: "BscNodeInstanceRoleArn"
        });
