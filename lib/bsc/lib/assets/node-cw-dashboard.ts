export const SyncNodeCWDashboardJSON = {
    "widgets": [
        ...
        },
        {
            ...
            "properties": {
                "metrics": [
                    [ "CWAgent", "bsc_sync_block", "InstanceId", "${INSTANCE_ID}", { "label": "${INSTANCE_ID}-${INSTANCE_NAME}" } ]
                ],
                "sparkline": true,
                "view": "timeSeries",
                "stacked": false,
        ...
        },
        {
            ...
            "properties": {
                ...
                "period": 60,
                "metrics": [
                    [ "CWAgent", "bsc_blocks_behind", "InstanceId", "${INSTANCE_ID}", { "label": "${INSTANCE_ID}-${INSTANCE_NAME}" } ]
                ],
                "title": "BSC Client Blocks Behind"
            }
        },
        {
            "height": 5,
