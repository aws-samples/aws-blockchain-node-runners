export const SyncNodeCWDashboardJSON = {
    "widgets": [
        ...
        },
        {
            ...
            "properties": {
                "metrics": [
                    [ "CWAgent", "fantom_sync_block", "InstanceId", "${INSTANCE_ID}", { "label": "${INSTANCE_ID}-${INSTANCE_NAME}" } ]
                ],
                "sparkline": true,
                "view": "timeSeries",
                "stacked": false,
                ...
                "stat": "Maximum",
                "period": 60,
                "title": "FANTOM Client Block Height"
            }
        },
        {
            "height": 4,
            ...
            "properties": {
                ...
                "period": 60,
                "metrics": [
                    [ "CWAgent", "fantom_blocks_behind", "InstanceId", "${INSTANCE_ID}", { "label": "${INSTANCE_ID}-${INSTANCE_NAME}" } ]
                ],
                "title": "FANTOM Client Blocks Behind"
            }
        },
        {
            "height": 5,
