...
export class ScrollSingleNodeStack extends cdk.Stack {
    constructor(scope: cdkConstructs.Construct, id: string, props: ScrollSingleNodeStackProps) {
        ...
        // Setting up the security group for the node from Scroll-specific construct
        const instanceSG = new ScrollNodeSecurityGroupConstruct (this, "security-group", {
            vpc: vpc,
        })
        ...
        new cw.CfnDashboard(this, 'scroll-cw-dashboard', {
