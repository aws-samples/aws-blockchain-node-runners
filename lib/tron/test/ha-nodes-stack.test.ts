...
describe("TronHANodesStack", () => {
  test("synthesizes the way we expect", () => {
    const app = new cdk.App();

    // Create the TronHANodesStack.
    const tronHANodesStack = new TronHANodesStack(app, "tron-sync-node", {
    stackName: `tron-ha-nodes-${config.baseNodeConfig.nodeConfiguration}`,
    ...
    const template = Template.fromStack(tronHANodesStack);
    ...
    template.hasResourceProperties("AWS::AutoScaling::AutoScalingGroup", {
      AutoScalingGroupName: `tron-ha-nodes-${config.baseNodeConfig.nodeConfiguration}`,
    ...
    template.hasResourceProperties("AWS::AutoScaling::LifecycleHook", {
      ...
      LifecycleHookName: `tron-ha-nodes-${config.baseNodeConfig.nodeConfiguration}`,
    ...
    template.hasResourceProperties("AWS::ElasticLoadBalancingV2::LoadBalancer", {
      LoadBalancerAttributes: [
        ...
        },
        {
         ...
         Value: `tron-ha-nodes-${config.baseNodeConfig.nodeConfiguration}`
        }
       ],
       Scheme: "internal",
       SecurityGroups: [
    ...
    template.hasResourceProperties("AWS::ElasticLoadBalancingV2::TargetGroup", {
      ...
      HealthCheckPath: "/wallet/getnowblock",
