...
export interface TronHANodesStackProps extends cdk.StackProps, configTypes.TronBaseNodeConfig, configTypes.TronHAConfig {
}

export class TronHANodesStack extends cdk.Stack {
    constructor(scope: cdkConstructs.Construct, id: string, props: TronHANodesStackProps) {
        ...
        // setting up the security group for the node from TRON-specific construct
