export const SyncNodeCWDashboardJSON = {
    "widgets": [
        ...
        },
        {
            ...
            "properties": {
                "metrics": [
                    [ "CWAgent", "tron_sync_block", "InstanceId", "${INSTANCE_ID}", { "label": "${INSTANCE_ID}-${INSTANCE_NAME}" } ]
                ],
                "sparkline": true,
                "view": "timeSeries",
                "stacked": false,
                ...
                "stat": "Maximum",
                "period": 60,
                "title": "TRON Client Block Height"
            }
        },
        {
            "height": 4,
            ...
            "properties": {
                ...
                "period": 60,
                "metrics": [
                    [ "CWAgent", "tron_blocks_behind", "InstanceId", "${INSTANCE_ID}", { "label": "${INSTANCE_ID}-${INSTANCE_NAME}" } ]
                ],
                "title": "TRON Client Blocks Behind"
            }
        },
        {
            "height": 5,
