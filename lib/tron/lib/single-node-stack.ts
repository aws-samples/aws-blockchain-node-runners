...
export interface TronSingleNodeStackProps extends cdk.StackProps, configTypes.TronBaseNodeConfig {
}

export class TronSingleNodeStack extends cdk.Stack {
    constructor(scope: cdkConstructs.Construct, id: string, props: TronSingleNodeStackProps) {
        ...
        const instanceSG = new TronNodeSecurityGroupConstructs (this, "security-group", {
            vpc: vpc,
        })
