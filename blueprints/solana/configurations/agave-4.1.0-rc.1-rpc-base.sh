...
# Solana Agave - Base RPC Node Configuration
# Provides standard RPC API access to the Solana network
# Suitable for most RPC use cases
...
echo "Starting Agave validator (base RPC) on $EC2_INTERNAL_IP..."
